...
This directory holds the normative specification and its supporting
implementation map. For usage, installation, and examples, see the
...
- [`ARCHITECTURE_DETAILED.md`](ARCHITECTURE_DETAILED.md) — a non-normative
  implementation map with repository structure, class relationships, ownership
  and state diagrams, runtime sequences, platform boundaries, and validation
  flows.
