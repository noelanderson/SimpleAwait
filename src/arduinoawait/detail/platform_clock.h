...
// ArduinoAwait — platform monotonic microsecond clock.
//
...
//
//   ARDUINOAWAIT_CLOCK_NOW_US  advanced/testing override (e.g. host fake clock)
...
// ---------------------------------------------------------------------------
#if defined(ARDUINOAWAIT_CLOCK_NOW_US)

namespace arduinoawait {
namespace detail {
inline uint64_t platform_now_us() noexcept {
    return static_cast<uint64_t>(ARDUINOAWAIT_CLOCK_NOW_US());
}
} // namespace detail
} // namespace arduinoawait
