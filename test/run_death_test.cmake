...
#
# The default SimpleAwait error hook is [[noreturn]] and calls std::abort() on
...
#   * it launched and reached the hook (emitting the SA_DEATH_TEST_REACHED
...
#
# Invoked as: cmake -DSA_EXE=<path> -P run_death_test.cmake

if(NOT DEFINED SA_EXE)
    message(FATAL_ERROR "SA_EXE not set")
endif()
if(NOT EXISTS "${SA_EXE}")
    message(FATAL_ERROR "death-test executable not found: ${SA_EXE}")
endif()
...
string(FIND "${_all}" "SA_DEATH_TEST_REACHED" _marker)
if(_marker EQUAL -1)
    message(FATAL_ERROR
