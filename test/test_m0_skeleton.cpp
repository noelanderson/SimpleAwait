...
//
// No SimpleAwait scheduling exists yet at M0; this test deliberately uses only
...
static_assert(SIMPLEAWAIT_VERSION_MAJOR == 0, "version major");
static_assert(SIMPLEAWAIT_VERSION_MINOR == 1, "version minor");
